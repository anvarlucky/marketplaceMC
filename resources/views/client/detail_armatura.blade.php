                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset('/assets/image_qur_material/D32armatura.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/18mm_armatura.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/armatura3.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/armatura4.jpg')}}" class="w-100" alt="details">
                            </div>

                            <img src="{{asset('/assets/image_qur_material/armatura5.jpg')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title">Armatura turlari</p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1.Armatura ishlari – temir-be-ton konstruksiyalar va inshootlarni qurishda armaturalar tayyorlash, ma’lum shaklga keltirish va joylashtirish kabi ishlar majmui.
                                Diametri 10 mm gacha boʻlgan sim-armatura zavoddan qurilish maydoniga 200 m uzunlikdagi oʻram holida, diametri 14 mm dan ortiq boʻlgan chiviq 10 – 12 m uzunlikda
                                keltiriladi. Keltirilgan armatura simlarini toʻgʻrilash, taranglash, maxsus chizmaga qarab kesish, sinch va toʻrlar tayyorlash va ularni qoliplar ichiga oʻrnatish
                                Armatura ishlari jumlasiga kiradi. Diametri 10 mm gacha boʻlgan sim armatura toʻgʻrilash-kesish avtomatlarida, katta diamet-rli poʻlat armaturalar esa potok
                                lini-yalarda toʻgʻrilab kesiladi.
                                ...
                                <br>
                                <br>
                                2. Armaturalar sterjenli va simli armaturalarga bo'linadi
                            </p>
                        </div>
            ...
            <div class="swiper special-swiper rounded mt-4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                ...
                                <p class="special-ad">D32mm armatura</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                ...
                                <p class="special-ad">18mm armatura</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/armatura3.jpg')}}" height="160" class="w-100" alt="special">
                                <p class="special-ad">D32mm armatura</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item px-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/armatura4.jpg')}}" height="160" class="w-100" alt="special">
                                <p class="special-ad">18mm armatura</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item pe-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/armatura5.jpg')}}" height="160" class="w-100" alt="special">
                                <p class="special-ad">D32mm armatura</p>
