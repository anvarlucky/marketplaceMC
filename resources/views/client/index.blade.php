            ...
            <div class="swiper special-swiper rounded mt-4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                               <a href="/details"><img src="{{asset('/assets/images/special_1.png')}}" height="160" class="w-100" alt="special"></a>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <a href="/details"> <img src="{{asset('/assets/images/special_2.png')}}" height="160" class="w-100" alt="special"></a>
                                <p class="special-ad">MAZ-KS-45729A-0-01 ko'chma krani</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <a href="/details"> <img src="{{asset('/assets/images/special_3.png')}}" height="160" class="w-100" alt="special"></a>
                                <p class="special-ad">MAZ-KS-45729A-0-01 ko'chma krani</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item px-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <a href="/details"> <img src="{{asset('/assets/images/special_4.png')}}" height="160" class="w-100" alt="special"></a>
                                <p class="special-ad">MAZ-KS-45729A-0-01 ko'chma krani</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item pe-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <a href="/details">  <img src="{{asset('/assets/images/special_5.png')}}" height="160" class="w-100" alt="special"></a>
                                <p class="special-ad">MAZ-KS-45729A-0-01 ko'chma krani</p>
