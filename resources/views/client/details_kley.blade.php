                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset('/assets/image_qur_material/kley1.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/kley1.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/kley1.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/kley1.png')}}" class="w-100" alt="details">
                            </div>

                            <img src="{{asset('/assets/image_qur_material/kley1.png')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title">Kley markasini tekshi</p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1.Kley - bu ozgina qurilish materiallaridan biridir, ularsiz hech qanday qurilish mumkin emas.
                    ...
                    <ul class="details-info">
                        <li class="d-flex align-items-start">
                            ...
                            <p class="details-info_text">
                                Toshkent shahri, Bektemir tumani, Chirchiq bo'yi ko'chasi, 9-uy
                            </p>
                        </li>
                        <li class="d-flex align-items-start">
            ...
            <div class="swiper special-swiper rounded mt-4">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/travertin1.png')}}" height="160" class="w-100" alt="special">
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/kley1.png')}}" height="160" class="w-100" alt="special">
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset("/assets/image_qur_material/kley2.png")}}" height="160" class="w-100" alt="special">
                    ...
                    <div class="swiper-slide">
                        <div class="special-item px-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/travertin2.png')}}" height="160" class="w-100" alt="special">
                                <p class="special-ad">Travertin ventum color</p>
