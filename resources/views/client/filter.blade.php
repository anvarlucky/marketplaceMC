    ...
    <div class="container category">
        <div class="row mt-4">
            ...
            <div class="d-flex align-items-center justify-content-between px-0 py-3">
                <p class="dry-title mb-0">Yuk avtomobillari</p>

                <div class="btn-group" role="group" aria-label="Basic example">
                    <button type="button" class="btn text-white btn-primary">Reyting bo‘yicha</button>
                    <button type="button" class="btn btn-outline-primary">Arzonlari</button>
                    <button type="button" class="btn btn-outline-primary">Qimmatlari</button>
                </div>
            </div>
            <div class="category-item ps-lg-0">
                <a href="/categories" class="d-block text-center p-3 border rounded">
