                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset('/assets/images/details.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/images/details_1.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/images/details_2.png')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/images/details_3.png')}}" class="w-100" alt="details">
                            </div>

                            <img src="{{asset('/assets/images/details.png')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title">Mini yuk mashinalari uchun korpus</p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1. Korxonada ma'lum bir harorat rejimini talab qiladigan yuklarni tashish uchun
                                mo'ljallangan
