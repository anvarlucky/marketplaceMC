                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset('/assets/cars_images/ekskavator5.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/cars_images/ekskavator4.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/cars_images/ekskavator3.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/cars_images/ekskavator2.jpg')}}" class="w-100" alt="details">
                            </div>

                            <img src="{{asset('/assets/cars_images/ekskavator1.jpg')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title">Ekskavatorlar</p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1Ushbu sahifada siz Ekskavatorlar turkumidagi kompaniyalar takliflari haqida ma'lumot olishingiz mumkin.
                                Takliflar narxlari, batafsil tavsifi va O'zbekiston bozorida faoliyat yurituvchi yetkazib beruvchilarning
                                aloqa ma'lumotlarini o'z ichiga oladi.
                                Ekskavatorlar turkumidagi kompaniyalar haqidagi ma'lumotlar Prom.uz saytiga kiritilgan. Ayni paytda ba'zi
                                yetkazib beruvchilar haqidagi ma'lumotlar (manzil, telefon, joylashuv yoki tovarlar va xizmatlar ro'yxati)
                                o'zgargan bo'lishi mumkin. Kompaniyalar ro'yxati doimiy ravishda yangilanadi va kengaytiriladi. Ularning aloqa
                                ma'lumotlari va boshqa ma'lumotlar ham muntazam ravishda yangilanadi.
                                <br>
                                <br>

                                XCMKXE210WA Toshkent hududida
                                <br>
                                <br>
                                Hyunday Ekskavator
                                <br>
                                <br>
                                2. HYUNDAI ROBEX 140 W Ekskavatori
                            </p>
                        </div>

                        <div class="check_second">
                            <p class="mt-4">
                                2.Ushbu sahifada siz Ekskavatorlar turkumidagi kompaniyalar takliflari haqida ma'lumot olishingiz mumkin.
                                Takliflar narxlari, batafsil tavsifi va O'zbekiston bozorida faoliyat yurituvchi yetkazib beruvchilarning
                                aloqa ma'lumotlarini o'z ichiga oladi.
                                Ekskavatorlar turkumidagi kompaniyalar haqidagi ma'lumotlar Prom.uz saytiga kiritilgan. Ayni paytda ba'zi
                                yetkazib beruvchilar haqidagi ma'lumotlar (manzil, telefon, joylashuv yoki tovarlar va xizmatlar ro'yxati)
                        ...
                        <div class="check_third">
                            <p class="mt-4">
                                3.Ushbu sahifada siz Ekskavatorlar turkumidagi kompaniyalar takliflari haqida ma'lumot olishingiz mumkin.
                                Takliflar narxlari, batafsil tavsifi va O'zbekiston bozorida faoliyat yurituvchi yetkazib beruvchilarning
                                aloqa ma'lumotlarini o'z ichiga oladi.
                                Ekskavatorlar turkumidagi kompaniyalar haqidagi ma'lumotlar Prom.uz saytiga kiritilgan. Ayni paytda ba'zi
                                yetkazib beruvchilar haqidagi ma'lumotlar (manzil, telefon, joylashuv yoki tovarlar va xizmatlar ro'yxati)
