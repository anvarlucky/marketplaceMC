                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset("/assets/image_qur_material/g'isht.jpg")}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/gisht3.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/gisht4.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/gisht5.jpg')}}" class="w-100" alt="details">
                            </div>

                            <img src="{{asset('/assets/image_qur_material/images.jpg')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title"> Pishiq G'ishtlar </p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1.M-75 keramika g'ishtlari - bugungi kunda eng ko'p ishlovchi qurilish materiallari, uylar qurilishida
                                va qurilish maydonchalarini qurishda faol foydalanilmoqda. Oddiy qurilish g'ishtlari yuqori kuchga ega bo'lib,
                                muzlatish va muzdan tushirishning juda ko'p davrlariga chidamli bo'lib, yuqori zichlikka ega va uzoq vaqt yuqori
                                yuklarga qarshilik ko'rsatadi. Uning ajoyib xususiyatlari tufayli oddiy g'isht qurilish keramikasi eng keng
                                tarqalgan qurilish materiallaridan biriga aylandi.
                        ...
                        <div class="check_second">
                            <p class="mt-4">
                                2.M-75 keramika g'ishtlari - bugungi kunda eng ko'p ishlovchi qurilish materiallari, uylar qurilishida
                                va qurilish maydonchalarini qurishda faol foydalanilmoqda. Oddiy qurilish g'ishtlari yuqori kuchga ega bo'lib,
                                muzlatish va muzdan tushirishning juda ko'p davrlariga chidamli bo'lib, yuqori zichlikka ega va uzoq vaqt yuqori
                                yuklarga qarshilik ko'rsatadi. Uning ajoyib xususiyatlari tufayli oddiy g'isht qurilish keramikasi eng keng
                                tarqalgan qurilish materiallaridan biriga aylandi.
                        ...
                        <div class="check_third">
                            <p class="mt-4">
                                3. M-75 keramika g'ishtlari - bugungi kunda eng ko'p ishlovchi qurilish materiallari, uylar qurilishida
                                va qurilish maydonchalarini qurishda faol foydalanilmoqda. Oddiy qurilish g'ishtlari yuqori kuchga ega bo'lib,
                                muzlatish va muzdan tushirishning juda ko'p davrlariga chidamli bo'lib, yuqori zichlikka ega va uzoq vaqt yuqori
                                yuklarga qarshilik ko'rsatadi. Uning ajoyib xususiyatlari tufayli oddiy g'isht qurilish keramikasi eng keng
                                tarqalgan qurilish materiallaridan biriga aylandi.
            ...
            <div class="swiper special-swiper rounded mt-4">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="special-item ps-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="{{asset('/assets/image_qur_material/gisht4.jpg')}}" height="160" class="w-100" alt="special">
                                <p class="special-ad">Pishiq g'isht</p>
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="special-item px-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="image_qur_material/gisht5.jpg" height="160" class="w-100" alt="special">
                                <p class="special-ad">Pishiq g'isht</p>
                    ...
                    <div class="swiper-slide">
                        <div class="special-item pe-0">
                            <div class="p-3 border border-bottom-0 rounded-top">
                                <img src="image_qur_material/gisht4.jpg" height="160" class="w-100" alt="special">
                                <p class="special-ad">Pishiq g'isht</p>
