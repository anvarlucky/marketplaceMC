                ...
                <div class="row">
                    <div class="col-lg-6 pt-2 ps-lg-0">
                        <div class="details-image p-0">
                            <div class="column-img">
                                <img src="{{asset('/assets/image_qur_material/sement 2.jpg')}}" class="w-100 mb-3" alt="details">

                                <img src="{{asset('/assets/image_qur_material/sement.jpg')}}" class="w-100 mb-3" alt="details">
                            ...
                            <img src="{{asset('/assets/image_qur_material/sement6.jpg')}}" class="rounded w-80" alt="details">
                        </div>
                    </div>

                    <div class="col-lg-6 pt-2">
                        <p class="details-title">Sement markasini tekshi</p>
                    ...
                    <div class="col-12 px-lg-0 mt-5">
                        ...
                        <div class="check_first">
                            <p class="mt-4">
                                1.Sement - bu ozgina qurilish materiallaridan biridir, ularsiz hech qanday qurilish mumkin emas.
